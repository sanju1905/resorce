    ...
    <div class="container-fluid mt-4">
        <div class="row">
            ...
            <div class="col-md-10 offset-md-1 col-sm-12">
                <h4 class="pl-4"><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp; Materials </h4>
                <hr>
            </div>
        ...
        if(mysqli_num_rows($query_run) > 0)
        {
         ...
         ?>
            <div class="col-md-10 offset-md-1 col-sm-12">
                <a href="material_details.php?id=<?php echo $row['material_id']; ?>" style=" text-decoration: none
                    !important;">
            ...
            <div class="col-md-10 offset-md-1 col-sm-12 pt-3">
                <div class="alert alert-primary" role="alert">
                    <h5 class="text-secondary foont-weight-bold">No Materials Found</h5>
                </div>
