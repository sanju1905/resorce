<nav class="navbar navbar-expand-lg" style="background-color: #55198B !important;">
    <a class=" navbar-brand" href="index.php"><img src="assets/images/logo.png" alt="" width='45' height='45'>Resource
        Management</a>
        ...
        <ul class="navbar-nav ml-auto pr-4">
            ...
            <li class="nav-item px-2 mt-1">
                <a class="nav-link <?= (basename($_SERVER['PHP_SELF'])=="users.php")?"active":""; ?>"
                    href="users.php"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;
                    Users</a>
            </li>
            <li class="nav-item px-2 mt-1">
                <a class="nav-link <?= (basename($_SERVER['PHP_SELF'])=="materials.php")?"active":""; ?>"
                    href="materials.php"><i class="fa fa-list-alt" aria-hidden="true"></i>&nbsp;
                    Materials</a>
            </li>
            <li class="nav-item px-2  mt-1">
